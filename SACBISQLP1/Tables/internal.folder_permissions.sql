CREATE TABLE [internal].[folder_permissions] (
  ...
  CONSTRAINT [PK_Folder_Permissions] PRIMARY KEY CLUSTERED ([id]),
...
CREATE UNIQUE INDEX [Unique_FolderPermissions]
  ON [internal].[folder_permissions] ([object_id], [permission_type], [sid])
  ON [PRIMARY]
GO

ALTER TABLE [internal].[folder_permissions]
  ADD CONSTRAINT [FK_FolderPermissions_ObjectId_Folders] FOREIGN KEY ([object_id]) REFERENCES [internal].[folders] ([folder_id]) ON DELETE CASCADE
GO